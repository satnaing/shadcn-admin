...
export default function CountrySelector({ control, name, withRegions = false }: CountrySelectorProps) {
    ...
    <Controller
      ...
      render={({ field }) => (
        <MultiSelect
          options={options}
          maxCount={6}
          animationConfig={{ optionHoverAnimation: 'none', badgeAnimation: 'none' }}
