...
export function SwanFullLogoWhite({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      role='img'
      viewBox='0 0 408 108'
      ...
      {...props}
    >
      <title>Swan Full Logo White</title>
      <defs>
        <linearGradient
          x1='0%'
          y1='80.0817871%'
      ...
      <g id='swan-full-logo-white' stroke='none' fill='none' fillRule='evenodd'>
        ...
        <g id='swan-wordmark' transform='translate(113, 11)' fill='#FFFFFF'>
          <path
