...
export const creditRepairColumns: ColumnDef<Transaction>[] = [
  {
    accessorKey: 'id',
    header: ({ column }) => (
  ...
  {
    accessorKey: 'creditRepairReferenceCode',
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title='Credit Repair Reference Code' />
    ),
  },
]
