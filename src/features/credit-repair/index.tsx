...
import { creditRepairColumns } from './components/credit-repair-columns'
import { BBPSTablePagination } from './components/credit-repair-table-pagination'
      ...
      <Main> 
        <div className='mb-2 flex flex-wrap items-center justify-between space-y-2 gap-x-4'>
          <div>
            <h2 className='text-2xl font-bold tracking-tight'>
              Credit Repair Transaction Panel
            </h2>
        ...
        <div className="-mx-4 flex-1 overflow-auto px-4 py-1 lg:flex-row lg:space-y-0 lg:space-x-12">
          {isLoading ? (
            ...
            <>
              <TransactionsTable data={mappedData} columns={creditRepairColumns} />
              <BBPSTablePagination
                pageIndex={pageIndex}
